...
/**
 * Fundo 3D trazido da calculadora principal: estrelas em perspectiva,
 * brilho sutil e movimento suave acompanhando o cursor.
 */
  ...
  useEffect(() => {
    ...
    function draw(now: number) {
      ...
      for (const star of stars) {
        ...
        const color = star.orange ? "212,175,55" : "255,255,255";
    ...
    >
      {!transparent ? (
        <div
          ...
          style={{ background: "linear-gradient(180deg, #050505 0%, #0a0a0a 58%, #020202 100%)" }}
        />
      ) : null}
